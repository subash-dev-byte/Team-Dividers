...
divideTeams.addEventListener("click", () => {
  if (inputValues.value === "") {
    ...
    team1.className=" sm:w-[550px] ps-[25px] pe-[50px] pt-[30px] rounded-[10px]  bg-white  shadow-sm sm:shadow-lg "

    team2.className="  sm:w-[550px] ps-[25px] pe-[50px] pt-[30px] rounded-[10px] bg-white  shadow-sm sm:shadow-lg" 

    
    //team names
    const teamFirstName = document.createElement("h2");
    teamFirstName.innerText = "Team A";
    teamFirstName.className="text-3xl font-semibold text-center text-[#164765] mb-8"
    team1.appendChild(teamFirstName)
    
     const teamSecondName = document.createElement("h2");
    teamSecondName.innerText = "Team B";
    teamSecondName.className="text-3xl font-semibold text-center text-[#164765] mb-8"
...
teamA.forEach((element,i )=> {
    ...
    teamMemberContainers.className="flex items-center gap-4 bg-[#eaf4f7] px-6 py-4  rounded-xl shadow-sm mb-[25px] "
